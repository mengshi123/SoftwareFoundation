...
Proof.
  ...
  generalize dependent y2. induction H1; intros.
    ...
    - (* ST_Plus2 *) inversion H; subst. inversion H2; subst.
        + inversion H1.
        + inversion H5.
...
(* provable. apply ST_True twiceILL IN HERE *)
...
(* provable apply ST_True and ST_If. *)
(** [] *)
...
Proof.
 ...
 - right. inversion IHt1. 
   + inversion H. exists t2. apply ST_IfTrue.
     exists t3. apply ST_IfFalse.
   + inversion H. exists (tif x t2 t3).
...
Proof.
  ...
  inversion H as [H1 H2]; subst; clear H. unfold step_normal_form in H2.
  induction H1.
...
Proof.
  ...
  - (* ST_Plus2 *) inversion Hy2; subst.
     ...
     + inversion H; subst.
         ...
         * rewrite <- (IHHy1 t2'0). reflexivity. assumption.
         * rewrite <- (IHHy1 t2'0). reflexivity. assumption.
  - (* ST_IfTrue  *) inversion Hy2; subst.
     + reflexivity.
     + inversion H3.
  - (* ST_IfFalse *)  inversion Hy2; subst.
     + reflexivity.
     + inversion H3.
  - (* ST_If *)  inversion Hy2; auto; subst.
     + inversion Hy1.
     + inversion Hy1.
...
(** $Date: 2017-10-31 21:06:29 -0400 (Tue, 31 Oct 2017) $ *)
