...
Proof.
  ...
  apply false_beq_string in H. destruct (beq_string x1 x2).
  - inversion H.
  - reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  destruct (beq_string x x0) eqn:H. reflexivity.
  reflexivity.
Qed.
(** [] *)
...
Proof.
  ...
  intros H. apply beq_string_true_iff in H. apply H.
Qed.
(** [] *)
...
Theorem t_update_same : forall X x (m : total_map X),
  ...
  apply functional_extensionality. intros x0.
  destruct (beq_string x x0) eqn: Ht.
  apply f_equal. specialize (beq_string_true_iff x x0); intros.
...
Proof.
  ...
  unfold t_update. destruct (beq_string x1 x) eqn: Hb1.
  - destruct (beq_string x2 x) eqn: Hb2.
    + apply beq_string_true_iff in Hb1. apply beq_string_true_iff in Hb2.
