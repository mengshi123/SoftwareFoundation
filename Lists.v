...
Proof.
  simpl. destruct p as[n m]. simpl. reflexivity. Qed.
(** [] *)
...
Fixpoint subset (s1:bag) (s2:bag) : bool :=
  ...
  | nil => true
  | h1 :: t1 => 
      andb (member h1 s2)(subset t1 (remove_one h1 s2))
  end.
...
Theorem bag_theorem : forall s:bag, forall v:nat,
  count v (add v(add v s)) = 2 + count v s.
Proof.
  intros s v. simpl.
